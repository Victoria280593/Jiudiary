...
export function TiedBeltIcon({
  ...
  return (
    <svg viewBox="0 0 120 64" className={className} role="img" aria-label={`${BELT_LABELS[belt]} пояс`}>
      <path d="M5 21.5 45 20l4.5 12L5 33.5Z" fill={colors.main} stroke={outline} strokeWidth="1.2" strokeLinejoin="round" />
      <path d="m71 20 44 1.5v12L70.5 32Z" fill={secondary} stroke={outline} strokeWidth="1.2" strokeLinejoin="round" />
      <path d="m52 31 10 4-13 24-12-6Z" fill={colors.main} stroke={outline} strokeWidth="1.2" strokeLinejoin="round" />
      <path d="m68 31-10 4 13 24 12-6Z" fill={secondary} stroke={outline} strokeWidth="1.2" strokeLinejoin="round" />
      <path d="m37 53 12 6 4-7.5-12-6Z" fill={rankColor} />
      <path d="m67 51.5 4 7.5 12-6-4-7.5Z" fill={rankColor} />
      <path d="M60 11 77 24.5 60 40 43 24.5Z" fill={colors.main} stroke={outline} strokeWidth="1.3" strokeLinejoin="round" />
